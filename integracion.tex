...
Sin el uso del motor de reglas, este cambio implica el cambio/adición de una 32 líneas de código. Seguidamente, se debe volver a compilar y desplegar el sistema para hacer estos cambios efectivos.

Haciendo uso de la integración descrita, se requiere realizar el cambio del \cref{tbl:cambio:original} al \cref{tbl:cambio:cambiado}. 
El cambio es detectado en tiempo de ejecución y se generan las nuevas clases wrapper, sin necesidad de volver a compilar o desplegar el sistema.
