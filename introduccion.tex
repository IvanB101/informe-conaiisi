...
%
El backend del nuevo sistema, \acrshort{si}-\acrshort{dospu}, está implementado en el lenguaje de programación Java, el framework Spring y la base de datos PostgresSQL; y el frontend está implementado utilizando el framework Angular. 
