...
%
Las tecnologías de implementación incluyen, el lenguaje de programación Java, el framework Spring y la base de datos PostgreSQL para el backend, y Angular para el frontend. 
...
\revisar{No deberían estar más adelante según el formato del informe?}
